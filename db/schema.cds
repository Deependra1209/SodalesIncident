...
context RL1 {
    ...
    entity SAVEASDRAFT {
        ...
        EH7tHCcx0nEJhiCM : Association to many BASICINCIDENTDETAILS on EH7tHCcx0nEJhiCM.INCID = INCID;
        IIGz0nJCwaqoHRpj : Association to many NEARMISSDETAILS on IIGz0nJCwaqoHRpj.INCID = INCID;
        mansC7FYakJKTpDd : Association to many ERGONOMICS on mansC7FYakJKTpDd.INCID = INCID;
        EeuYgCtOeMl4xfCJ : Association to many FIREEXPLOSIONDETAILS on EeuYgCtOeMl4xfCJ.INCID = INCID;
        Y1uHdls1PSJSbfCJ : Association to many OTHERINCIDENTTYPE on Y1uHdls1PSJSbfCJ.INCID = INCID;
        TS552Ngd1qq8fuyg : Association to many PROPERTYEQUIPMENTDAMAGE on TS552Ngd1qq8fuyg.INCID = INCID;
        H5Xh9V2YIdzKIOX0 : Association to many ENVIRONMENTALDETAILS on H5Xh9V2YIdzKIOX0.INCID = INCID;
        W2WX8BzOHx7dLcdK : Association to many EXPOSURE on W2WX8BzOHx7dLcdK.INCID = INCID;
        dpsypg7rG7ZobbhO : Association to many VEHICLEADDITIONALDETAILS on dpsypg7rG7ZobbhO.INCID = INCID;
        fEJmWPFObKIc1Bw5 : Association to many WORKPLACEHARASSMENT on fEJmWPFObKIc1Bw5.INCID = INCID;
        u6LPdHfhOvTlda1E : Association to many GETATTACHMENTDOC on u6LPdHfhOvTlda1E.INCID = INCID;
        FiwUwrGzPlSnwlEw : Association to many CUSTOMINCIDENTTYPE_1 on FiwUwrGzPlSnwlEw.INCID = INCID;
        AwlahRPmU1NJQLRW : Association to many CUSTOMINCIDENTTYPE_2 on AwlahRPmU1NJQLRW.INCID = INCID;
        u0vC6COnRtYUUN5Y : Association to many CUSTOMINCIDENTTYPE_3 on u0vC6COnRtYUUN5Y.INCID = INCID;
        zYi0aoNJwN0eEw85 : Association to many CUSTOMINCIDENTTYPE_4 on zYi0aoNJwN0eEw85.INCID = INCID;
        sRO9sKpkZJdGYKPO : Association to many CUSTOMINCIDENTTYPE_5 on sRO9sKpkZJdGYKPO.INCID = INCID;
    }    
    ...
    entity BASICINCIDENTDETAILS {
        ...
        P5lCp2CAsMt0D5hX : Association to many INCIDENTTYPE on P5lCp2CAsMt0D5hX.INCID=INCID;
        oLEsFv4evC49NxxO : Association to many INCIDENTREPORTEDBYDETAILS on oLEsFv4evC49NxxO.INCID=INCID;
        b7kybQF9bmbnYkES : Association to many INVOLVEDPEOPLEDETAILS on b7kybQF9bmbnYkES.INCID=INCID;
    }
